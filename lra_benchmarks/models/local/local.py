...
class LocalTransformerSeq2SeqBlock(nn.Module):
...
class LocalTransformerSeq2SeqDecoder(nn.Module):
  ...
  def apply(self,
    ...
    for lyr in range(num_layers):
      y = LocalTransformerSeq2SeqBlock(
          y,
          encoded,
          qkv_dim=qkv_dim,
          mlp_dim=mlp_dim,
...
class LocalTransformerSeq2Seq(nn.Module):
  ...
  def apply(self,
    ...
    encoded = LocalTransformerEncoder(
        inputs,
        inputs_positions=inputs_positions,
        inputs_segmentation=inputs_segmentation,
        vocab_size=vocab_size,
    ...
    logits = LocalTransformerSeq2SeqDecoder(
        encoded,
        src_padding_mask,
        targets,
