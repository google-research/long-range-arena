...
class LinearTransformerSeq2SeqBlock(nn.Module):
  """LinearTransformer encoder-decoder layer."""
...
class LinearTransformerSeq2Seq(nn.Module):
  """LinearTransformer Model for sequence to sequence translation."""
  ...
  def apply(self,
            ...
            attention_dropout_rate=0.1,
            cache=None):
    """Applies LinearTransformer model on the inputs.
    ...
    encoded = LinearTransformerEncoder(
        inputs,
        inputs_positions=inputs_positions,
        inputs_segmentation=inputs_segmentation,
        vocab_size=vocab_size,
