...
from lra_benchmarks.models.transformer.transformer import TransformerSeq2SeqDecoder
...
class LinformerSeq2SeqBlock(nn.Module):
  """Linformer encoder-decoder layer."""
  ...
  def apply(self,
            ...
            deterministic=False,
            cache=None):
    """Applies LinformerSeq2Seq module.

    Note that Linformer cannot be used to decode, so we use a TransformerBlock.
...
class LinformerSeq2Seq(nn.Module):
  """Linformer Model for sequence to sequence translation."""
  ...
  def apply(self,
            ...
            attention_dropout_rate=0.1,
            cache=None):
    """Applies Linformer model on the inputs.
    ...
    logits = TransformerSeq2SeqDecoder(
        encoded,
        src_padding_mask,
        targets,
